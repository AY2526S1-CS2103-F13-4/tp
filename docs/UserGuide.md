...
**Caution:**
If the data file is **malformed** (invalid JSON) or contains **incompatible values** (e.g., negative IDs, missing required fields),
Neighbourly may **fail to start or crash** on launch.
